                    ...
                    <Link href={`/profile/${author.id}`} className="w-fit">
                        ...
                        <div className={`${isComment && 'mb-10'}mt-5 flex flex-col gap-3`}>
                            <div className="flex gap-3.5">
                                {/* like */}
                                <Image src="/assets/heart-gray.svg" alt="heart" width={25} height={25} className="cursor-pointer object-contain"></Image>
                                {/* reply */}
                                <Link href={`/thread/${id}`}>
                                <Image src="/assets/reply.svg" alt="reply" width={25} height={25} className="cursor-pointer object-contain"></Image>
                                </Link>

                                {/* repost */}
                                <Image src="/assets/repost.svg" alt="repost" width={25} height={25} className="cursor-pointer object-contain"></Image>
                                {/* share */}
